...
with open('OrgQuestion_to_RelQuestion_stats.csv', 'w') as csvfile:
    ...
    for original_question in original_questions:
        ...
        for related_question in related_questions:
            ...
            orginal_question_body = basic_stats.remove_subject_from_question(
            ...
            row[JACCARD_DISTANCE] = round(basic_stats.jaccard_distance(
                orginal_question_body, related_question_body), 3)
            row[LENGTH_DIFFERENCE] = basic_stats.length_difference(
                orginal_question_body, related_question_body)
            ...
            row[BIGRAM_SIMILARITY] = round(basic_stats.ngram_similarity(
                orginal_question_body, related_question_body, n=2), 3)
