...
from keras.layers import Input, LSTM, Merge, Dense, Dropout
...
merged_vector = keras.layers.concatenate([question_output, comment_output], axis=-1)
...
output_category = Dense(3, activation="softmax")(x)

# Pack it all up into a model
malstm = Model([question_input, comment_input], [output_category])
optimizer = keras.optimizers.SGD(lr=0.002, momentum=0.0, decay=1e-6, nesterov=False, clipvalue=1.0)
